...
M1 should turn the contract into a runnable prototype on DietPi and qualify bootstrap, manifest validation, service lifecycle, persistence and reboot behavior on Orange Pi Zero 3.
